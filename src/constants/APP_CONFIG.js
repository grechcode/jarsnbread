...
export const MENU = {
  ...
  breads: {
    ...
    dishes: [
      ...
      {
        id: "custard_bread",
        name: "Белый с карамельным солодом",
        price: 260,
        hit: false,
        new: true,
        isAvailable: true,
        publicationUrl: "https://t.me/jarsnbread/78",
      }, 
      {
        id: "farmer_bread",
        name: "Фермерский с яблоком, морковкой и льном",
        price: 280,
        hit: false,
        new: true,
        isAvailable: true,      }, 
  ...
  desserts: {
    ...
    dishes: [
      ...
      },
      {
        ...
        new: false,
        isAvailable: true,
        publicationUrl: "https://t.me/jarsnbread/75",
      },
    ],
  },
};
